...
- 当前开发主线：**V2.0 架构地基已完成，出生 / 世界内容已完成首轮冻结，准备进入人生起点系统**。
- R00.1～R00.3 迁移准备已完成。
...
- `V2_CONTENT_BIBLE.md` 已建立，成为具体世界、出身、地点、人物、功法、物品、妖兽、事件等内容的首版真源。
...
已建立 `V2_CONTENT_BIBLE.md`，统一并冻结当前已认可内容，包括：

- 青霞地界、黑风矿变与 8 个主地点 / 区域；
- 青云宗、陆 / 孟 / 谢三家、西渠黑市；
...
- 重要 NPC 与轻量关系体系；
- 炼丹 / 炼器 / 御兽最小闭环；
- 3 个大型世界事件、6 条事件链、30 个普通事件骨架；
- 《此世记》/《此世传》的文风与禁用 AI 式句法。

同时已明确首版裁剪和仍需后续冻结的缺口：大境界突破具体资源、筑基至金丹传承、延寿物、随机子地点 / 秘境、重大机缘池和正式事件正文。Codex 不得自行用占位内容补齐这些缺口。
...
R05 第一次替换玩家可见的 legacy 开局入口。三个出生候选必须一次生成并保存，刷新不能重抽；选择后写入唯一 GameState，并进入童年阶段。

R05 的具体内容必须使用 `V2_CONTENT_BIBLE.md` 中冻结的 8 个出身、灵根、体质与首版 12 个天赋，不得自行发明替代内容。
