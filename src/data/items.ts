...
export const ITEM_DEFINITIONS = [
  ...
  { id: 'century_spirit_ginseng', name: '百年灵参', category: 'material', stackLimit: 10, slotCost: 1, tier: 2, quality: 'medium', description: '完整百年药龄灵参。可用于延寿，也可作为高阶恢复准备；同一株只能选择一种用途。', ruleTags: ['lifespan:effect:century-spirit-ginseng', 'breakthrough:golden-core-recovery'] },
